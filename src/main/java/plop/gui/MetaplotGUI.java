...
public class MetaplotGUI extends JFrame{
	...
	class StartListener implements ActionListener {
		...
		/**
		 * Test all the box, condition etc before to allow the program to run and dispose the main.java.plop.gui
		 */
	...
	class QuitListener implements ActionListener {
		...
		/**
		 * dipose the main.java.plop.gui and quit the program
		 */
		public void actionPerformed(ActionEvent actionEvent){
			_gui.dispose();
			System.exit(0);
	...
	class RBHicListener implements ActionListener{
		...
		/**
		 * manage the access of the different main.java.plop.gui element on function of the paramter choose
		 */
		public void actionPerformed(ActionEvent actionEvent){
			if (_gui.isSIP()){
				if(_gui.isCompare()){
