...
import plop.gui.MetaplotGUI;
import plop.multiProcessing.ProcessCoolerDumpData;
import plop.multiProcessing.ProcessDumpData;
import plop.utils.SIPMeta;


/**
 * This main class obtain all the parameter by the main.java.plop.gui or the command line to then run SIPMetaplot with the good parameters gave by the the user
 * 
...
public class MainMetaplot{
	...
	/**boolean: if true SIPMeta is run with a main.java.plop.gui */
	...
	/**
	 * Obtain the parameter from the main.java.plop.gui or the command line.
	...
	/**
	 * main.java.plop.test cool version
	 *
