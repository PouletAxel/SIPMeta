...
public class CoolerDumpData {
	 ...
	 *
	 * @param cooler String: path of cooler
	 * @param coolFile String path mcool file
	 */
	...
	/**
	 * setter expected
	 * @param lExpected ArrayList<Double>
	 */
