...
public class Script {
	 ...
	 * I think they should be in the main.java.plop.gui:
	 * -c in the python script should be an optional text entry in the main.java.plop.gui (or dropdown menu if possible) for any colorscheme in matplotlib. If not set in python script it defaults to Red.
	 * -z should be a checkbox in the main.java.plop.gui (default is no check). In the python script, the -z option calculates the zscores of each ring in the bullseye.
